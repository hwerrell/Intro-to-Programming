...
branch1 = "0" #Defining first decision toggle as 0 
branch2 = "0" #Defining second decision toggle as 0
branch3 = "0" #Defining third decision toggle as 0
...
while (branch1 != "1"):         #Decision tree 1 (open the door)
    branch1 = input("""
...
while (branch2 != "2"):         #Decision tree 2 (inside the shop)
    branch2 = input("""
...
while "river" not in branch3.lower():       #Decision tree 3 (riddle)
    branch3 = input("""\nWhat is your answer?\n""")
